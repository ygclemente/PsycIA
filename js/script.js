...
async function enviarMensagem(event) {
  ...
  // Chamada API
  let resposta = "Infelizmente só funcionamos localmente.";
  try {
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      headers: {
        ...
        Authorization: `Bearer ${
          "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"
        }`,
      },
      body: JSON.stringify({
        model: "gpt-3.5-turbo",
...
function logout() {
  ...
  window.location.href = "../PsycIA-main/html/login.html";
}
